...
// FIXED POINT
extern float
    RADIUS; // For the table, the radius of the circle containing fixed points
...
extern int STEP; // Step used for files generation, as instance a step of 10
                 // means 1 file generated every 10 update
