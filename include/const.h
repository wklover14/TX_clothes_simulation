...
// SPACE CONST
#define     SPACING                     0.01f                           //   standard spacing between two points on the same axis

// MESH CONST
#define     Mu                          1.00f                           // Mass of a point
#define     C_DIS                       0.0f                            // Damping coefficient
...
// FIXED POINT
#define     RADIUS                      0.025f                            // For the table, the radius of the circle containing fixed points
